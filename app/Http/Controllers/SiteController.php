...
class SiteController extends Controller {
    ...
    public function registeruser(){
        return view('front-end.registeruser');
    }

    public function showRegistrationForm()
    {
        // Fetch the active and featured courses
        $courses = Course::where('status', 1) // Assuming 1 means active
                          ->where('featured', 1) // Assuming featured = 1 means featured
                          ->get();

        // Return the view with the $courses variable
        return view('front-end.registeruser', compact('courses'));
    }
    // 
