...
Route::get('/register-user', [SiteController::class, 'showRegistrationForm'])->name('site.registeruser');



Route::get('/register-student', [StudentController::class, 'create'])->name('register.student.form'); // Display form
Route::post('/register-student', [StudentController::class, 'store'])->name('register.student'); // Handle form submission



Route::get('/', [SiteController::class, 'home'])->name('site.home');
Route::get('/about', [SiteController::class, 'about'])->name('site.about');
//Route::get('/register-user', [SiteController::class, 'registeruser'])->name('site.registeruser');
