  ...
  <div class="navbar-collapse collapse">
    <ul class="navbar-nav navbar-align">
      ...
      <li class="nav-item dropdown">
        ...
        <img src="{{ asset('img/avatars/avatar.jpg') }}" class="avatar img-fluid rounded me-1" alt="Avatar" />
        ...
        <a class="dropdown-item" href="{{ route('show.profile', Auth::guard('admin')->check() ? Auth::guard('admin')->user()->firstname . ' ' . Auth::guard('admin')->user()->lastname : (Auth::check() ? Auth::user()->firstname . ' ' . Auth::user()->lastname : 'Guest')) }}">
