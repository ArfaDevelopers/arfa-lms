...
<nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
  <a href="{{ route('site.home') }}" class="navbar-brand d-flex align-items-center px-4 px-lg-5">
    <h2 class="m-0 text-primary"><i class="fa fa-book me-3"></i>Arfa Tech LMS</h2>
  </a>
  ...
  <div class="collapse navbar-collapse" id="navbarCollapse">
    ...
    <a href="/register-user" class="btn btn-success py-4 px-lg-4 d-none d-lg-block">{{ __('Enroll Now') }}<i class="fas fa-arrow-right ms-3"></i></a>
  </div>
</nav>
<!-- Navbar End -->