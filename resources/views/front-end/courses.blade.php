      ...
      <div class="row g-4 justify-content-center">
        @forelse ($courses as $course)
          <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
            ...
            <img class="img-fluid" src="{{ Storage::url($course->details->thumbnail) }}" alt="Course Thumbnail">
    ...
    <div class="w-100 d-flex justify-content-center position-absolute bottom-0 start-0 mb-4">
        ...
        <a href="{{ route('enrollment', ['slug' => $course->slug, 'course_id' => $course->id]) }}" class="flex-shrink-0 btn btn-sm btn-primary px-3" style="border-radius: 0 30px 30px 0;">{{ __('Enroll') }}</a>
              ...
              <div class="d-flex border-top">
                <small class="flex-fill text-center border-end py-2"><i class="fa fa-clock text-primary me-2"></i>{{ $course->details->duration }}</small>
